...
- [ ] Initialize LittleJS project
  - [ ] Set up HTML file with LittleJS imports
  - [ ] Configure canvas at 1280x720 resolution
  - [ ] Set up basic engine initialization with callbacks
  - [ ] Implement simple grid background for spatial awareness
  - [ ] Test that engine runs at 60 FPS
...
### 4. Targeting System Logic
- Implement efficient target finding:
...
### Day 1 Milestone Tests
- [ ] Player moves correctly with WASD controls
